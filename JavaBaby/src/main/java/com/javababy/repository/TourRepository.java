...
import com.javababy.dto.TourDTO;
import com.javababy.entity.Tour;

@Repository
public interface TourRepository extends JpaRepository<Tour, Long>,JpaSpecificationExecutor<Tour> {
	
	@Query(value= "SELECT new com.javababy.dto.TourDTO(t.id,t.ten_tour,t.gioi_thieu_tour,t.so_ngay,t.noi_dung_tour,t.ngay_ket_thuc,t.ngay_khoi_hanh,t.diem_den,t.loai_tour,t.anh_tour,t.diem_khoi_hanh,t.trang_thai,t.gia_tour) FROM Tour t "
